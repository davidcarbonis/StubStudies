...
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/dtc_outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT Truncation=True
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/dtc_outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE Truncation=True
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/dtc_noTruncation_outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT Truncation=False
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/dtc_noTruncation_outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE Truncation=False

cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/dtc_outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT Truncation=True
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/dtc_outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE Truncation=True
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/dtc_noTruncation_outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT Truncation=False
cmsRun test/L1TrackNtupleMaker_DTC_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/dtc_noTruncation_outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE Truncation=False
