...
StubRateTool -i /vols/cms/adm10/MC/TMTT/StubStudies/TTbar_PU200_output/Tmtt_OldLoose/ -o /vols/cms/adm10/MC/TMTT/StubStudies/TTbar_PU200_output/StubRateToolOutput/outputTmttOldTight_all.root --particle="all"
#electrons
