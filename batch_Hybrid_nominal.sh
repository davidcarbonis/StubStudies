...
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./SingleElPt1p5to8_PU0.txt Events=-1 output=file:/vols/cms/adm10/MC/TMTT/StubStudies/SingleElPt1p5to8_output/outputHybridOldTight.root L1Algo=HYBRID StubWindow=OLD_TIGHT
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./SingleElPt1p5to8_PU0.txt Events=-1 output=file:/vols/cms/adm10/MC/TMTT/StubStudies/SingleElPt1p5to8_output/outputHybridOldLoose.root L1Algo=HYBRID StubWindow=OLD_LOOSE

cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./SingleMuPt1p5to8_PU0.txt Events=-1 output=file:/vols/cms/adm10/MC/TMTT/StubStudies/SingleMuPt1p5to8_output/outputHybridOldTight.root L1Algo=HYBRID StubWindow=OLD_TIGHT
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./SingleMuPt1p5to8_PU0.txt Events=-1 output=file:/vols/cms/adm10/MC/TMTT/StubStudies/SingleMuPt1p5to8_output/outputHybridOldLoose.root L1Algo=HYBRID StubWindow=OLD_LOOSE
