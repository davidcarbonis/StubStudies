...
process.load( 'L1Trigger.StubStudies.TTStubsFromDTCStubProducer_cff' )
...
# load track trigger associator to redo stub/cluster associatotion on new dtc stub collection
process.load('SimTracker.TrackTriggerAssociation.TrackTriggerAssociator_cff')

## cluster assoc
process.TTClusterAssociatorFromPixelDigis.TTClusters   = cms.VInputTag( cms.InputTag("TTClustersFromPhase2TrackerDigis", "ClusterInclusive"), 
                                                                        cms.InputTag("TTStubsFromPhase2TrackerDigis","ClusterAccepted"),
)

## stub assoc
process.TTStubAssociatorFromPixelDigis.TTStubs         = cms.VInputTag( cms.InputTag("TTStubsFromDTCStubProducer","DTCStubAccepted"), 
)
...
process.associateDTCStubs = cms.Path( process.TTClusterAssociatorFromPixelDigis * process.TTStubAssociatorFromPixelDigis )
...
if (L1TRKALGO == 'HYBRID'):
    ...
    process.TTTracksFromTrackletEmulation.TTStubSource  = cms.InputTag("TTStubsFromDTCStubProducer","DTCStubAccepted")
    process.TTTracksFromTrackletEmulation.MCTruthClusterInputTag = cms.InputTag("TTClusterAssociatorFromPixelDigis", "ClusterAccepted")
    process.TTTracksFromTrackletEmulation.MCTruthStubInputTag = cms.InputTag("TTStubAssociatorFromPixelDigis", "DTCStubAccepted")
    process.TTTrackAssociatorFromPixelDigis.TTTracks = cms.VInputTag( cms.InputTag(L1TRK_NAME, L1TRK_LABEL) )
    process.TTTrackAssociatorFromPixelDigis.TTClusterTruth = cms.InputTag("TTClusterAssociatorFromPixelDigis", "ClusterAccepted")
    process.TTTrackAssociatorFromPixelDigis.TTStubTruth    = cms.InputTag("TTStubAssociatorFromPixelDigis", "DTCStubAccepted")
...
# LEGACY ALGORITHM (EXPERTS ONLY): TMTT  
    ...
    L1TRK_PROC.clusterTruthInputTag  = cms.InputTag("TTClusterAssociatorFromPixelDigis", "ClusterAccepted")
