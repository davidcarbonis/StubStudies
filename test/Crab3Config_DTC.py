...
config.Data.outputDatasetTag = "CRAB3_MC_L1TrackNtupleMaker_dtc_{}_{}_{}_{}_{}".format(dataset.process, algoArg.process, stubWindow.process, dtcTruncation.process, time)
