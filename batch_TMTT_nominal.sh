...
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./TTBar_PU200.txt Events=-1 output=file:./TTbar_PU200_output/outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/outputTmttOldTight.root L1Algo=TMTT StubWindow=OLD_TIGHT
cmsRun test/L1TrackNtupleMaker_cfg.py inputMC=./TTBar_PU0.txt Events=-1 output=file:./TTbar_PU0_output/outputTmttOldLoose.root L1Algo=TMTT StubWindow=OLD_LOOSE
